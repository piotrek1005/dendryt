package com.dendryt.software.server.designer;
...
public class DesignerServlet extends RemoteServiceServlet implements IDesigner {

	private Logger logger;	
	private static final long serialVersionUID = 1L;
	DesignerImpl impl = new DesignerImpl();
