...
public class TesterController {
	private ITesterAsync designerService;
	private IUserManagementAsync UM; 

	private TesterInterface designerInterface;
		...
		TesterController(TesterInterface designerInterface) {
			designerService=(ITesterAsync) GWT.create(ITester.class);
			ServiceDefTarget endpoint = (ServiceDefTarget) designerService;
			endpoint.setServiceEntryPoint(GWT.getModuleBaseURL() + "/ITester");
