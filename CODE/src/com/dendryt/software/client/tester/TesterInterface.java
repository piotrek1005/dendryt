...
public class TesterInterface implements IUserInterface {
	private RootPanel rootPanel;
	private TesterController designerController;
	...
	public TesterInterface(String userName) {
...
//		});
		...
		designerController = new TesterController(this);
		rootPanel = RootPanel.get();
	}

	public void mainInterface() {
		Window.setTitle("Dendryt - Interfejs testera");
	...
	Grid addingReport() {
		...
		final Button dalej = new Button("Do serwisanta (wdrozenie)", new ClickListener() {
		...
		final Button wczesniej = new Button("Do programisty", new ClickListener() {
	...
	HorizontalPanel selfReportsRevisionInterface() {
		...
		if(((selfReportsList.get(selfReportsList.size() - 1).userType == IFunkcje.PROGRAMISTA) && selfNotificationsList.get(selfNotificationsListWidget.getSelectedIndex()).doPrzodu()) ||
				((selfReportsList.get(selfReportsList.size() - 1).userType == IFunkcje.SERWISANT) && !selfNotificationsList.get(selfNotificationsListWidget.getSelectedIndex()).doPrzodu()))
