...
public class ProgrammerController {
	private IProgrammerAsync designerService;
	private IUserManagementAsync UM; 

	private ProgrammerInterface designerInterface;
		...
		ProgrammerController(ProgrammerInterface designerInterface) {
			designerService=(IProgrammerAsync) GWT.create(IProgrammer.class);
			ServiceDefTarget endpoint = (ServiceDefTarget) designerService;
			endpoint.setServiceEntryPoint(GWT.getModuleBaseURL() + "/IProgrammer");
