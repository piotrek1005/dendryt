...
private IDesignerAsync designerService;
private IUserManagementAsync UM; 

private DesignerInterface designerInterface;
	...
	DesignerController(DesignerInterface designerInterface) {
		designerService=(IDesignerAsync) GWT.create(IDesigner.class);
		ServiceDefTarget endpoint = (ServiceDefTarget) designerService;
		endpoint.setServiceEntryPoint(GWT.getModuleBaseURL() + "/IDesigner");
