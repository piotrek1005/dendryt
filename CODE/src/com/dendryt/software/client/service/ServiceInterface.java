...
public class ServiceInterface implements IUserInterface {
	private RootPanel rootPanel;
	private ServiceController designerController;
	...
	public ServiceInterface(String userName) {
...
//		});
		...
		designerController = new ServiceController(this);
		rootPanel = RootPanel.get();
	}

	public void mainInterface() {
		Window.setTitle("Dendryt - Interfejs serwisanta");
	...
	Grid addingReport() {
		...
		final Button dalej = new Button("Do projektanta", new ClickListener() {
		...
		final Button wczesniej = new Button("Do testera", new ClickListener() {
	...
	HorizontalPanel selfReportsRevisionInterface() {
		...
		if(((selfReportsList.get(selfReportsList.size() - 1).userType == IFunkcje.TESTER) && selfNotificationsList.get(selfNotificationsListWidget.getSelectedIndex()).doPrzodu()) ||
				((selfReportsList.get(selfReportsList.size() - 1).userType == IFunkcje.PROJEKTANT) && !selfNotificationsList.get(selfNotificationsListWidget.getSelectedIndex()).doPrzodu()))
